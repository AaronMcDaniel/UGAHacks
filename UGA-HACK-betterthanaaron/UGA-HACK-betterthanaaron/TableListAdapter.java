...
public class TableListAdapter extends ArrayAdapter<Table> {
    ...
    public TableListAdapter(Context context, int textViewResourceID, ArrayList<Table> tableList) {
        super(context, textViewResourceID, tableList);

    }

    //make second method with comments in it. Give method new name
    @Override
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (table != null) {
            ...
            EditText input = (EditText) v.findViewById(R.id.editText);
            ...
            if (input != null) {
                inputs.add(input); //Find a way to make this bit work, or keep all references of the
